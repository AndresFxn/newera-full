...
export const getDelivererOrders = async (delivererId, { status, page, limit }) => {
  ...
  // Filtrar órdenes asignadas al domiciliario O disponibles para tomar (DISPATCHED sin asignar)
  const where = {
    OR: [
      { delivererId }, // Órdenes asignadas al domiciliario
      { status: 'DISPATCHED', delivererId: null }, // Órdenes disponibles para tomar
    ],
