            ...
            <div className="space-y-5">
              ...
              <p className="text-base text-center text-slate-700 dark:text-slate-300 font-normal pt-4">
                ...
                <button
                  ...
                  className="font-bold text-[#1c6554] dark:text-green-400 hover:text-[#1c6554]/70 dark:hover:text-green-300 transition-colors"
                >
                  Regístrate
                </button>
              </p>
        ...
        >
          ...
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20 dark:border-slate-700/50">
            ...
            <div className="space-y-4">
              ...
              <div className="text-xs text-slate-600 dark:text-slate-400 space-y-1 -mt-2 px-1">
                <p className="font-semibold">La contraseña debe tener:</p>
                <ul className="list-disc list-inside space-y-0.5 ml-2">
                  <li className={registerData.password.length >= 8 ? 'text-green-600 dark:text-green-400' : ''}>
                    Mínimo 8 caracteres
                  </li>
                  <li className={/[A-Z]/.test(registerData.password) ? 'text-green-600 dark:text-green-400' : ''}>
                    Al menos una mayúscula
                  </li>
                  <li className={/[a-z]/.test(registerData.password) ? 'text-green-600 dark:text-green-400' : ''}>
                    Al menos una minúscula
                  </li>
                  <li className={/\d/.test(registerData.password) ? 'text-green-600 dark:text-green-400' : ''}>
                    Al menos un número
                  </li>
                </ul>
              </div>
