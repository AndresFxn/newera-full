...
export default function MyProfilePage() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    // TODO: Implementar cambio de contraseña cuando el backend tenga el endpoint
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                {!isEditing ? (
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-[#1c6554] dark:text-green-400 hover:bg-[#1c6554]/10 dark:hover:bg-green-900/20 rounded-lg transition-colors"
                  >
                    Editar
                  </button>
                ) : (
              ...
              {isEditing ? (
                <form onSubmit={handleSaveProfile} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full px-4 py-3 bg-gradient-to-r from-[#1c6554] to-[#0C447C] dark:from-green-600 dark:to-blue-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all"
                  >
                    Guardar Cambios
                  </button>
                </form>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm">
            ...
            {!isChangingPassword ? (
              <button
                ...
                className="px-4 py-2 text-sm font-semibold text-[#1c6554] dark:text-green-400 hover:bg-[#1c6554]/10 dark:hover:bg-green-900/20 rounded-lg transition-colors flex items-center gap-2"
              >
                <LockIcon />
                Cambiar Contraseña
              </button>
