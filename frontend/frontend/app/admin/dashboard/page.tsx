            ...
            {[
              ...
              <div key={idx} className="group">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-medium text-slate-900 dark:text-white line-clamp-1 group-hover:text-[#1c6554] transition-colors">
                    {product.name}
                  </p>
                  <span className="text-xs font-semibold text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded-full">
                    {product.sold}
                  </span>
                </div>
