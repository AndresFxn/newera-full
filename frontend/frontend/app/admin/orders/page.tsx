  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <StatCard title="Pagados" value={stats.paid} color="blue" />
        <StatCard title="Preparando" value={stats.preparing} color="purple" />
        <StatCard title="Despachados" value={stats.dispatched} color="orange" />
        <StatCard title="Entregados" value={stats.delivered} color="green" />
      </div>
                  ...
                  <tr key={order.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="text-sm font-semibold text-[#1c6554] dark:text-green-400 hover:text-[#0C447C] dark:hover:text-green-300 transition-colors"
                      >
                        Ver detalles →
                      </button>
                    </td>
...
function StatCard({ title, value, color }: StatCardProps) {
  ...
  return (
    <div className={`rounded-xl p-4 border-2 ${colors[color]} hover:shadow-md transition-all`}>
